 ...
 * @creator     z10926<br/>
 * @create-time 2015年12月7日 下午9:39:15
 * @revision    $Id:  *
 **********************************************************************
 */
public class WestLayoutTag extends BodyTagSupport{
	...
	public int doStartTag() throws JspException {
		...
		sb.append("<td id=\"westLayoutId\" style=\"padding: 0 0 0 0;margin: 0 0 0 0;\"");
	...
	public int doEndTag() throws JspException {
		...
		TagUtil.setTagPageContextParam(pageContext,"WEST",this.width, "");
		sb.append("</td>");
		try {      
            JspWriter out = pageContext.getOut();      
            out.println(sb.toString());      
