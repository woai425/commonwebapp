package com.h3c.portal.business.modeler.editor.model;
  ...
  implements ModelDataJsonConstants
{
  ...
  private RepositoryService repositoryService;
	...
	@RequestMapping(value = { "/{modelId}/json" }, method = { org.springframework.web.bind.annotation.RequestMethod.GET }, produces = { "application/json" })
	@ResponseBody
