...
<h3c:form action="passwordController.do?updatePassword">
<h3c:groupbox isRetracted="true" style="margin: 10px 10px 10px 10px;" property="userinfo" title="基本信息">
	...
	<h3c:tabLayOut column="2"/>
		...
		<tr>
			<h3c:textEdit property="passwd" required="true" inputType="password" value="${user.passwd }" label="密码" width="260" onchange="checkLength()"></h3c:textEdit>
		</tr>
		...
		<tr>
			<h3c:textEdit property="confirmPasswd" required="true" inputType="password" value="${user.passwd }" label="确认密码" width="260" onchange="checkPassword()"></h3c:textEdit>
		</tr>
		<tr>
...
<tr>
	<td>
		<table>
			...
			<tr>
				<td width="36%"></td>
				<td align="center"><h3c:button text="保存" handler="updatePassword()" property="update" fontAwesome="icon-save"></h3c:button></td>
				<td width="10%"></td>
				<td align="center"><h3c:button text="取消" handler="closeUpdatePd()" property="close" fontAwesome="icon-undo"></h3c:button></td>
				<td width="30%"></td>
			</tr>
		</table> 
	<td>
...
function closeUpdatePd(){
	h3c.closeWindow("openUpdatePassword");
}
