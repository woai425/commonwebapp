...
<body>         
	<h3c:form action="roleController.do?saveRole" name="Role">
		<table style="height: 100%; width: 100%; border: 0px solid red; background: #fff; " >
			<tr style="height:5px;" ></tr>	
			<tr>
				<h3c:hidden property="roleid" value="${role.roleid }"></h3c:hidden>
			</tr>
			<tr>
				<td style="width:35px;"></td>
				<h3c:textEdit label="角色名称" property="rolename"  required="true" labelAlign="true" value="${role.rolename }" />
			</tr>
			<tr>
				<td style="width:35px;"></td>
				<h3c:textEdit label="角色描述" property="roledesc" labelAlign="true" value="${role.roledesc }"/>				    
			</tr>
			<tr>
				<td style="width: 35px;"></td>
